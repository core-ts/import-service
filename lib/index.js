...
var ImportService = (function () {
    ...
    ImportService.prototype.import = function () {
        var e_3, _a, e_4, _b;
        return __awaiter(this, void 0, void 0, function () {
            var total, success, v, lineSkiped, lastLine, i, _c, _d, _line, r, e_3_1, r, i, _e, _f, _line, r, r, e_4_1;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        total = 0;
    ...
    ImportService.prototype.validateAndWrite = function (lastLine, total, v, i) {
        var e_5, _a;
        return __awaiter(this, void 0, void 0, function () {
            var success, _b, _c, line, rs, errors, r, err_3, e_5_1, r, err_4;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 22:
                        err_4 = _d.sent();
                        if (this.exceptionHandler) {
                            this.exceptionHandler.handleException(lastLine, err_4, i, this.filename);
                        }
                        return [3, 23];
    ...
    ImportService.prototype.transformAndWrite = function (lastLine, total, i) {
        var e_6, _a;
        return __awaiter(this, void 0, void 0, function () {
            var success, _b, _c, line, rs, r, err_5, e_6_1, r, err_6;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        success = 0;
